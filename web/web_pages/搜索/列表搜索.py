...
cols[4].date_input("起始时间", value=None, key="start", disabled=st.session_state["kind"]!= "高级")
cols[5].date_input("结束时间", value=None, key="end", disabled=st.session_state["kind"]!= "高级")
