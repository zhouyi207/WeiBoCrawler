...
def get_body_response(search_for: str, page_index: int, *,  kind : Literal["综合", "实时", "高级"] = "综合", 
                      advanced_kind: Literal["综合", "热度", "原创"] = "综合", time_start: Optional[datetime], time_end=Optional[datetime]) -> httpx.Response:
    """获取列表页响应
